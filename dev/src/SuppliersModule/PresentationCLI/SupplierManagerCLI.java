...
public class SupplierManagerCLI {
    //------------------------------------------ Attributes ---------------------------------------
    OrderCLI orderCLI;
    CreateSupplierCLI createSupplierCLI;
    ...
    public SupplierManagerCLI() {
        ...
        this.orderCLI = new OrderCLI();
        this.createSupplierCLI = new CreateSupplierCLI();
    ...
    public void PowerOn() {
        ...
        while (!Choose.equals("0")) {
            ...
            switch (Choose) {
                case "1":
                    createSupplierCLI.createNewSupplier();
                    break;
                case "2":
                    orderCLI.createPeriodicOrder();
                    break;
                case "3":
     ...
     */
    public void showSupplierOrdersHistory() {
    ...
    private void UpdateSupplierAgreement() {
        ...
        while (!Choose.equals("0")) {
            ...
            switch (Choose) {
                case "1":
                    createSupplierCLI.CreateSupplierAndAgreement("a", supplierNum, "a", PaymentTerm.values()[2], null, true);
                    break;
                case "2":
                    createSupplierCLI.createSupplierProduct(supplierNum);
                    break;
                case "3":
        ...
        while (!Choose.equals("0")) {
            ...
            switch (Choose) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    createSupplierCLI.addOrderDiscount(supplierNum);
                    break;
                case "4":
    ...
    private void AddProductDiscount(String supplierNum){
        ...
        if(supplierController.checkIfSupplierSupplyProduct(supplierCatalog, supplierNum)){
            createSupplierCLI.addProductDiscount(supplierCatalog, supplierNum);
        }
        else
            System.out.println("The product is not supply by the supplier");
    ...
    private void DeleteOrderDiscount(String supplierNum){
        ...
        int minimumAmount = CheckIntInputAndReturn("Enter the minimum amount:");
        if(supplierController.deleteOrderDiscount(supplierNum, priceOrQuantity, minimumAmount))
            System.out.println("The discount has been deleted\n");
        else
            System.out.println("The discount is not exist\n");
    }
    ...
    private void UpdateSupplierPaymentTerm(String supplierNum){
        supplierController.updateSupplierPaymentTerm(supplierNum, createSupplierCLI.enterPaymentTerm());
    }
