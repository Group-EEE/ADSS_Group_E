...
class SpecificProductTest {
    ...
    void isDefective() {
        ...
        p.addSpecificProduct("0001",5, 1234, LocalDateTime.parse("2023-03-04T00:00:00"), true, "sapir", true, "shufersal", -1, d,"open");
    ...
    void setDefective() {
        Discount d = new Discount(LocalDateTime.parse("2023-03-04T00:00:00"), LocalDateTime.parse("2023-03-15T00:00:00"), 25);
        p.addSpecificProduct("0001",5, 1234, LocalDateTime.parse("2023-03-04T00:00:00"), false, "sapir", true, "shufersal", -1, d,null);
    ...
    void getDefect_Report_By() {
        Discount d = new Discount(LocalDateTime.parse("2023-03-04T00:00:00"), LocalDateTime.parse("2023-03-15T00:00:00"), 25);
        p.addSpecificProduct("0001",5, 1234, LocalDateTime.parse("2023-03-04T00:00:00"), false, null, true, "shufersal", -1,d, null);
    ...
    void setInWarehouse() {
        Discount d = new Discount(LocalDateTime.parse("2023-03-04T00:00:00"), LocalDateTime.parse("2023-03-15T00:00:00"), 25);
        p.addSpecificProduct("0001",5, 1234, LocalDateTime.parse("2023-03-04T00:00:00"), false, null, false, "shufersal", 10, d,null);
    ...
    void getDiscount() {
        Discount d = new Discount(LocalDateTime.parse("2023-03-04T00:00:00"), LocalDateTime.parse("2023-03-15T00:00:00"), 25);
        p.addSpecificProduct("0001",5, 1234, LocalDateTime.parse("2023-03-04T00:00:00"), false, null, false, "shufersal", 10, d,null);
        assertEquals(25, p.getSpecificProducts().get(0).getDiscount().getDiscount());
    }
    ...
    void setDiscount() {
        ...
        assertEquals(55, p.getSpecificProducts().get(0).getDiscount().getDiscount());
    }

    @Test
    void getSp_ID() {
        Discount d = new Discount(LocalDateTime.parse("2023-03-04T00:00:00"), LocalDateTime.parse("2023-03-15T00:00:00"), 25);
        p.addSpecificProduct("0001",5, 1234, LocalDateTime.parse("2023-03-04T00:00:00"), false, "sapir", false, "shufersal", 10, d,null);
