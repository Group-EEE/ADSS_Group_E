...
class SpecificProductTest {
    ...
    void setDefective() {
        Discount d = new Discount(LocalDateTime.parse("2023-03-04T00:00:00"), LocalDateTime.parse("2023-03-15T00:00:00"), 25);
        p.addSpecificProduct(1234, LocalDateTime.parse("2023-03-04T00:00:00"), false, "sapir", true, "shufersal", -1, d);
    ...
    void getDefect_Report_By() {
        Discount d = new Discount(LocalDateTime.parse("2023-03-04T00:00:00"), LocalDateTime.parse("2023-03-15T00:00:00"), 25);
        p.addSpecificProduct(1234, LocalDateTime.parse("2023-03-04T00:00:00"), false, null, true, "shufersal", -1, d);
    ...
    void setInWarehouse() {
        Discount d = new Discount(LocalDateTime.parse("2023-03-04T00:00:00"), LocalDateTime.parse("2023-03-15T00:00:00"), 25);
        p.addSpecificProduct(1234, LocalDateTime.parse("2023-03-04T00:00:00"), false, "sapir", false, "shufersal", 10, d);
