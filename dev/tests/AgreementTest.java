...
class AgreementTest {
    ...
    void CheckIfExistOrderDiscount() {
        assertEquals(true, s1.getMyAgreement().CheckIfExistOrderDiscount("q",(float) 80,100));
        assertEquals(false, s1.getMyAgreement().CheckIfExistOrderDiscount("p",(float) 60,60));
