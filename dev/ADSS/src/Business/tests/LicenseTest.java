...
class LicenseTest {
    ...
    @Test
    void setL_ID() {
        License license = new License(646843, cold_level.Cold, 98465.23);
    ...
    @Test
    void setCold_level() {
        License license = new License(954867, cold_level.Cold, 98347.98);
    ...
    @Test
    void getCold_level() {
        License license = new License(65468, cold_level.Freeze, 58765.25);
        assertEquals(1, license.getCold_level().getValue());
        assertNotEquals(2, license.getCold_level().getValue());
        assertNotEquals(3, license.getCold_level().getValue());
        License license1 = new License(32154, cold_level.Cold, 47612.30);
        ...
        License license2 = new License(874351, cold_level.Dry, 94683.65);
    ...
    @Test
    void getWeight() {
        License license = new License(324543, cold_level.Freeze, 4555.90);
    ...
    @Test
    void setWeight() {
        License license = new License(846959, cold_level.Cold, 984653.20);
